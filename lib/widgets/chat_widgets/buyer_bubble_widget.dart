...
Widget buyerBubbleWidget(DocumentSnapshot data) {
  // Correctly retrieve the DateTime from the 'created_on' field
  final timeData =
  ...
  return Column(
      ...
      .color(tealColor)
      .margin(const EdgeInsets.only(bottom: 5, left: 3.5, right: 7.5))
      .padding(const EdgeInsets.only(left: 8.5, top: 6, bottom: 6, right: 6))
      .customRounded(
